...
- [x] Verify dark mode toggles all tokens correctly
...
- [x] Add environment variables to `.env.local` (`NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`)
...
- [x] Ensure landing page works in both light and dark mode
...
- [x] Landing page renders with correct fonts (Fraunces headings, Bricolage body)
- [x] Light/dark mode toggle works and persists across page reload
- [x] Dark mode auto-detects browser preference on first visit
- [x] Navbar renders with correct layout
- [x] Supabase client connects (check browser console for no errors)
- [x] BookCover renders placeholder gradient when no image provided
- [x] All pages responsive on mobile viewport
